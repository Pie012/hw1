...
<body>
            ...
            <div class="info-item2">
                ...
                <div id="barra-ricerca" class="nascosto">
                    <form method="post" id="prod-ric">
                        <input type="text" id="contenuto" placeholder="Cerca">
    ...
    <div id="corpo">
        <div class="testo">
            <h1>SCOPRI IL NUOVO LANCIO OCCHIALI FERRARI </h1>
        </div>
        <div id="tasto-cont">
            <a class="tasto" href="">SCOPRI</a>
        </div>
    </div>
    <div id="banner">
        <div class="text">
            <h2>NEW SEASON LOOKS</h2>
        </div>
        <div id="prodotti">
            <button id="b_sinistra">
                < </button>
                    <div id="prod-item1">
                        <div class="direction">
                            <div class="direction-item">
                                <div class="immagine"><img src="immagini/camicia.jpg" alt=""></div>
                                <div class="descrizione">camicia in drill di cotone<br>€790 </div>
                                <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                            </div>
                            <div class="direction-item">
                                <div class="immagine"><img src="immagini/pantaloni.jpg" alt=""></div>
                                <div class="descrizione">Pantalone jogger di cotone <br> €550</div>
                                <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                            </div>
                            <div class="direction-item">
                                <div class="immagine"><img src="immagini/polo.jpg" alt=""></div>
                                <div class="descrizione">Polo in cotone monocolore <br> €240</div>
                                <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                            </div>
                        </div>
                    </div>
                    <div id="prod-item2" class="hidden">
                        <div class="direction">
                            <div class="direction-item">
                                <div class="immagine"><img src=" immagini/cappello1.jpeg" alt=""></div>
                                <div class="descrizione">Cappello con logo Ferrari<br>€290 </div>
                                <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                            </div>
                            <div class="direction-item">
                                <div class="immagine"><img src="immagini/giacca.jpg" alt=""></div>
                                <div class="descrizione">Giacca bomber nylon <br> €1290</div>
                                <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                            </div>
                            <div class="direction-item">
                                <div class="immagine"><img src="immagini/maglione.jpg" alt=""></div>
                                <div class="descrizione">Maglione in cotone monocolore <br> €490</div>
                                <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                            </div>
                        </div>
                    </div>
                    <!--Slider che verrà visualizzato da telefono-->
                    <div class="invisibile">
                        <div id="prod-item11">
                            <div class="direction">
                                <div class="direction-item">
                                    <div class="immagine"><img src="immagini/camicia - Copia.jpg" alt=""></div>
                                    <div class="descrizione">Giacca in drill di cotone<br>€790 </div>
                                    <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                                </div>
                                <div class="direction-item">
                                    <div class="immagine"><img src="immagini/pantaloni - Copia.jpg" alt=""></div>
                                    <div class="descrizione">Pantalone jogger di cotone <br> €550</div>
                                    <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                                </div>
                            </div>
                        </div>
                        <div id="prod-item22" class="hidden">
                            <div class="direction">
                                <div class="direction-item">
                                    <div class="immagine"><img src=" immagini/cappello.jpg" alt=""></div>
                                    <div class="descrizione">Cappello con logo Ferrari<br>€290 </div>
                                    <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                                </div>
                                <div class="direction-item">
                                    <div class="immagine"><img src="immagini/giacca - Copia.jpg" alt=""></div>
                                    <div class="descrizione">Giacca bomber nylon <br> €1290</div>
                                    <div class="acquista" id="mess"><a class="a_acquista" href="">Acquista</a></div>
                                </div>
                            </div>
                    ...
                    <!--fine classe dello slider per modalita telefono-->
                    <button id="b_destra">></button>
        </div>
    </div>

    <div id="collezioni">
        <div class="foto-collezione">
            <div class="foto1"></div>
            <div class="descrizione-f">RAY-BAN PER SCUDERIA FERRARI</div>
            <div class="btn-f"><a class="tasto1" href="">Acquista</a></div>
        </div>
        <div class="foto-collezione">
            <div class="foto2"></div>
            <div class="descrizione-f">COLLEZIONE REPLICA</div>
            <div class="btn-f"><a class="tasto1" href="">Acquista</a></div>
        </div>
    </div>
    ...
    <div id="modellini">
        ...
        <div class="raccolta">
            <div class="muso">
                <img id="macchina" src="immagini/muso - Copia.jpg" alt="">
            </div>
            <div class="modello">
                <div class="immagine1"><img src="immagini/molellosf-23.jpg" alt=""></div>
                <div class="descrizione1">Modello in scala SF-23 1:8 <br> € 9.000</div>
                <div class="acquista1"><a class="a_acquista" href="">Acquista</a></div>
            </div>
        </div>
    </div>
    <div id="new-modello">
        <div class="cont">
            <div class="text1">
                <h2>COLLEZIONE SS24</h2>
            </div>
            <div class="mod-24"></div>
            <div class="btn-f1"><a class="tasto1" href="">SCOPRI</a></div>
        </div>
    </div>
    <div id="store">
        <div class="container">
            ...
            <div class="img-desc">
                <h2>Ferrari Flagship Store Milano </h2>
                <p>Nuova espressione dell’estetica Ferrari, il flagship store di Milano invita a un’iconica esperienza
                    immersiva, proponendo una commistione distintiva di Heritage e avanguardia. Lo spazio nasce in
                    continuità e come evoluzione del punto vendita di Maranello, a partire dallo stesso concept ideato
                    dallo Studio Sybarite di Londra.
                </p>
                <a class="button1" href="">Scopri</a>
                <h3>TROVA LO STORE PIÙ VICINO A TE</h3>
                <div class="search-div">
                    <input class="search" type="search">
                    <div class="btn-f2"><a class="tasto2" href="">SCOPRI</a></div>
                </div>
            </div>
        </div>
    </div>
    <footer>
        <section id="iscrizione">
            <h2>Iscrizione Email</h2>
            <p>Registrati per ricevere aggiornamenti sulle ultime collezioni</p>
            <input class="search1" type="search">
            <div class="btn-f3"><a class="tasto3" href="">PROSEGUI</a></div>
        </section>
        <!----------------------------------------INIZIO_MHW3--------------------------------------------------------------------->

        <div id="form_div">
            <form action="" id="search">
                <h2>SCOPRI GLI ULTIMI AGGIORNAMENTI SUL CAMPIONATO DI FORMULA 1</h2>
                <select name="" id="anno">
                    <option value="0" selected>Seleziona una stagione</option>
                    <option value="2024"> Stagione 2024</option>
                    <option value="2023"> Stagione 2023</option>
                    <option value="2022">Stagione 2022</option>
                </select>

                <select name="" id="round">
                    <option value="0" selected>Sceglio un Gran Premio</option>
                    <option value="1">GP 1</option>
                    <option value="2">GP 2</option>
                    <option value="3">GP 3</option>
                    <option value="4">GP 4</option>
                    <option value="5">GP 5</option>
                    <option value="6">GP 6</option>
                    <option value="7">GP 7</option>
                    <option value="8">GP 8</option>
                    <option value="9">GP 9</option>
                    <option value="10">GP 10</option>
                    <option value="11">GP 11</option>
                    <option value="12">GP 12</option>
                    <option value="13">GP 13</option>
                    <option value="14">GP 14</option>
                    <option value="15">GP 15</option>
                    <option value="16">GP 16</option>
                    <option value="17">GP 17</option>
                    <option value="18">GP 18</option>
                    <option value="19">GP 19</option>
                    <option value="20">GP 20</option>
                    <option value="21">GP 21</option>
                    <option value="22">GP 22</option>
                    <option value="23">GP 23</option>
                    <option value="24">GP 24</option>
                </select>

                <select name="" id="position">
                    <option value="0" selected>Scegli la posizione da visualizzare</option>
                    <option value="1">POSIZIONE 1</option>
                    <option value="2">POSIZIONE 2</option>
                    <option value="3">POSIZIONE 3</option>
                    <option value="4">POSIZIONE 4</option>
                    <option value="5">POSIZIONE 5</option>
                    <option value="6">POSIZIONE 6</option>
                    <option value="7">POSIZIONE 7</option>
                    <option value="8">POSIZIONE 8</option>
                    <option value="9">POSIZIONE9</option>
                    <option value="10">POSIZIONE 10</option>
                </select>
                <input type="submit" id='submit' value='invia'>
            </form>
            <article id="risultatoGara">
        ...
        <div id="form_spotify">
            ...
            <form id="spotify">
                <h2>Inserisci il nome di un album </h2>
        ...
        <div id="generale">
            ...
            <div class="cambi">
                ...
                <div class="cambi-text">
                    <p>CAMBI E RESI GRATUITI</p>
                </div>
            </div>
            <div class="serv">
                <div class="serv-img">
