...
<head>
    ...
    <script src="ricerca_prodotti_barra.js" defer></script>
</head>
...
<body>
            ...
            <div class="info-item2">
                ...
                <div id="barra-ricerca" class="nascosto">
                    <form method="post" id="prod-ric">
                        <input type="text" id="contenuto" placeholder="Cerca" value="<?php echo "$nome"; ?>">
            ...
            <div class="info-item3">
                ...
                <div id="myModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="box_prodotti_carrello">
                            <h1>Carrello</h1>
                            <div class="prodotti_carrello" id="listaprd1">
    ...
    <body>
        <div class="box_prodotti">
            <h1>Mostra risultati per "<?php echo "$nome"; ?>"</h1>
